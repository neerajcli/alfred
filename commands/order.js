...
module.exports = {
  ...
  let orderActive = await db.get('activeorder_' + message.author.id)
   ...
   return result;
        ...
        await db.set('orderitem_' + message.author.id, item)
        await db.set('orderprice_' + message.author.id, args[0])
        ...
        await db.sub('cash_' + message.author.id, args[0])
        await db.set('activeorder_' + message.author.id, true)
